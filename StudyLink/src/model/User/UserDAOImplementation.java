...
public static int adduser(User user) throws SQLException{
    String query = "insert into Users (user_id,,username,user_password,user_role,first_name,last_name ) values (??????)";
    ...
    public List<Course> userCourses(String username) throws SQLException {
